%===========================================================
% Holes Program (Classical)
% Date Created: June 28, 2018
% Based on the May 6 Holes Script
%===========================================================
countlimit=m*10;
...
while count<countlimit
    ...
    while success==0
        ...
        %--Avoid Loops--
        if direction==1 && relMat(addTwo,addOne)==-1
            direction=0;
        elseif direction==0 && relMat(addTwo,addOne)==1
            direction=1;
        end
        %---------------
        success=1;
...
for coarseRigid=1:rigidTest
    ...
    if coarseRigid~=1
        newlink=adjMat;
        N=m;
        eventsToRemove = round(N*(P(1)/100));
